...
ADD INDEX login_index (login),
ADD INDEX haslo_index (haslo);
...
ADD INDEX cena_index (cena),
ADD INDEX czas_index (Czas_wykonania);
...
ADD FOREIGN KEY (Id_Dostawcy) REFERENCES DOSTAWCA(Id_Dostawcy),
ADD INDEX data_rozpoczecia_index (Czas_realizacji_Data_rozpoczecia),
ADD INDEX data_zakonczenia_index (Czas_realizacji_Data_zakonczenia);

ALTER TABLE MATERIAL_DOSTAWCA
ADD FOREIGN KEY (Id_Materialu) REFERENCES MATERIAL(Id_Materialu),
ADD FOREIGN KEY (Id_Dostawcy) REFERENCES DOSTAWCA(Id_Dostawcy);

ALTER TABLE TYP_MEBLA
ADD INDEX nazwa_index (nazwa);
...
ALTER TABLE STAN_REALIZACJI
ADD INDEX nazwa_index (Nazwa_Stanu);
